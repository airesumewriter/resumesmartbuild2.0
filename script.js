...
// Login Modal logic const loginModal = document.getElementById("loginModal"); const closeLoginModal = document.querySelector(".close");
...
// Signup Popup Modal Logic const signupPopup = document.getElementById("signupPopup"); const getStartedBtn = document.getElementById("getStartedModalBtn"); const closeSignup = document.getElementById("closeSignup");

getStartedBtn.addEventListener("click", () => { signupPopup.style.display = "flex"; });

closeSignup.addEventListener("click", () => { signupPopup.style.display = "none"; });

window.addEventListener("click", (event) => { if (event.target === signupPopup) { signupPopup.style.display = "none"; } });
